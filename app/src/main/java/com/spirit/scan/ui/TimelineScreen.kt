                    ...
                    Card(
                        ...
                        Column(modifier = Modifier.padding(12.dp)) {
                            Row(
                                ...
                                Text(text = e.jonesLabel, color = Color(0xFFCCCCCC), fontSize = 13.sp)
                                Text(
                                    text = SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(Date(e.timestamp)),
                                    color = Color(0xFF666666),
                                    fontSize = 12.sp
                                )
                            }
                            Spacer(modifier = Modifier.height(4.dp))
                            Text(text = e.narrative, color = Color(0xFFE0E0E0), fontSize = 14.sp, maxLines = 3)
                        }
                    }
                }
            }
